# Lesson 3 Practice Pages

このフォルダの中身を、新しく作ったGitHubリポジトリのルートにアップロードしてください。

## 入っているページ

- `index.html`  
  Practice 1 / Practice 2 への入口ページ

- `sdl-sps2026/lesson3/practice1/`  
  Lesson 3 Practice 1
...
GitHubのリポジトリで `Settings` → `Pages` を開き、以下を選びます。
